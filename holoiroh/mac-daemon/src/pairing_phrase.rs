...
pub const WORDLIST: [&str; 256] = [
    "acid", "alarm", "album", "anchor", "apple", "april", "arena", "atlas", "aztec", "bacon",
    "badge", "baker", "banjo", "basil", "beach", "bench", "berry", "bison", "black", "blend",
    "blimp", "block", "bloom", "board", "bonus", "boost", "brave", "bread", "brick", "brisk",
    "broom", "brush", "bugle", "cabin", "cable", "cactus", "camel", "candy", "canoe", "canyon",
    "cargo", "carol", "cedar", "chalk", "charm", "chess", "chief", "chime", "cider", "cigar",
    "civic", "clamp", "clash", "clay", "clerk", "cliff", "cloak", "clock", "clove", "clown",
    "cobra", "cocoa", "comet", "coral", "couch", "cover", "coyote", "crane", "crate", "crisp",
    "crown", "crumb", "crust", "curry", "dance", "dandy", "daisy", "delta", "denim", "depot",
    "diner", "ditch", "diver", "dodge", "donor", "dough", "draft", "drama", "dress", "drift",
    "drone", "eagle", "ember", "envoy", "epoch", "extra", "fable", "fancy", "feast", "fence",
    "ferry", "fiber", "field", "finch", "flame", "flare", "flask", "fleet", "flint", "float",
    "flock", "flute", "focus", "forge", "fossil", "frost", "fudge", "gecko", "genie", "ghost",
    "giant", "glass", "glide", "globe", "glove", "grape", "grill", "grove", "guide", "gumbo",
    "gusto", "harbor", "hazel", "heron", "hobby", "honey", "hotel", "hound", "ivory", "jazz",
    "jelly", "jetty", "jewel", "jolly", "juice", "jumbo", "kayak", "kettle", "koala", "label",
    "lager", "lasso", "latch", "ledge", "lemon", "lever", "lilac", "linen", "llama", "locket",
    "lodge", "lotus", "lunar", "lyric", "macro", "mango", "maple", "marble", "medal", "melon",
    "mercy", "metro", "mimic", "miner", "mocha", "motto", "mound", "mural", "nacho", "nectar",
    "niece", "ninja", "noble", "nomad", "notch", "novel", "oasis", "ocean", "olive", "onion",
    "opera", "orbit", "otter", "owlet", "oxide", "paddle", "panda", "panel", "pansy", "parka",
    "pasta", "patio", "pearl", "pecan", "penny", "perch", "piano", "pilot", "pixel", "pizza",
    "plaza", "plume", "polar", "pouch", "prism", "prize", "proud", "puma", "punch", "quail",
    "quartz", "quest", "quill", "quilt", "radar", "raft", "raven", "razor", "relic", "rhino",
    "ridge", "rival", "robin", "rodeo", "rugby", "ruler", "salsa", "sauna", "scarf", "scout",
    "sedan", "sheep", "shell", "shrub", "siren", "sloth", "solar", "spice", "spine", "spoon",
    "sprout", "squid", "stork", "sugar", "syrup", "tulip",
];
